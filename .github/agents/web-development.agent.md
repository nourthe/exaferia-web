...
## Core Abilities
- **Project Planning & Estimation**: Helps structure milestones, estimate workload,
  and create technical roadmaps.
- **Context Management**: Organizes requirements, business rules, component
  inventories, data models, and design constraints to maintain clarity as the
  project evolves.
- **Prompt Engineering Support**: Generates optimized prompts for design tools
...
- Detail or validate implementation decisions
- Break down complex features into actionable tasks
- Draft UI components or page layouts
- Improve code quality or consistency
- Generate structured prompts for image/design creation
